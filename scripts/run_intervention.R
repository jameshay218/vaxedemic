run_intervention <- function(prop_travel) {
  ...
  output_prefix <- paste0("intervention_", num2str(prop_travel))
  ...
  n_runs <- 100
  intervention_params <- list(tintervene = 35, prop_travel = prop_travel)
  ...
  life_history_params <- list(R0=2, TR=3.6, LP = 6.4, case_fatality_ratio = rep(1e-3,2))
