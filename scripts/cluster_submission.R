...
epsilons <- c(0.00001, 0.01)#0.00005, 0.0001,0.0005,0.001,0.005,0.01)
amps <- seq(0.1,1,by=0.9)#05)
...
jobs <- queuer::enqueue_bulk(obj, runs, "calibrating_amp_and_travel","", n_runs=3, tmax=tmax, tdiv=tdiv, 
